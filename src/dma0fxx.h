...
#pragma pack(pop)
  ...
  enum Dma::Channel
    {
        Channel1_ADC_1        = 0x10,        
        Channel1_TIM17_CH1_1  = 0x10,
        Channel1_TIM17_UP_1   = 0x10,
      
        Channel2_ADC_2        = 0x11,
        Channel2_SPI1_RX      = 0x11,
        Channel2_USART3_TX_2  = 0x11,
        Channel2_USART1_TX_1  = 0x11,
        Channel2_I2C1_TX      = 0x11,
        Channel2_TIM1_CH1     = 0x11,        
        Channel2_TIM3_CH3     = 0x11,
        Channel1_TIM17_CH1_2  = 0x11,
        Channel1_TIM17_UP_2   = 0x11,
        
        
        
        Channel3_SPI1_TX      = 0x12,
        Channel3_USART1_RX_1  = 0x12,
        Channel3_USART3_RX_2  = 0x12,
        Channel3_I2C1_RX      = 0x12,
        Channel3_TIM1_CH2     = 0x12,        
        Channel3_TIM3_CH4     = 0x12,
        Channel3_TIM3_UP      = 0x12,
        Channel3_TIM6_UP      = 0x12,       
        Channel3_TIM16_CH1_1  = 0x12,
        Channel3_TIM16_UP_1   = 0x12,
                
       
        Channel4_SPI2_RX      = 0x13,
        Channel4_USART1_TX_2  = 0x13,
        Channel4_USART2_TX    = 0x13,
        Channel4_I2C2_TX      = 0x13,
        Channel4_TIM1_CH4     = 0x13,
        Channel4_TIM1_TRIG    = 0x13,
        Channel4_TIM1_COM     = 0x13,
        Channel4_TIM3_CH1     = 0x13,
        Channel4_TIM3_TRIG    = 0x13,
        Channel4_TIM7_UP      = 0x13,
        Channel3_TIM16_CH1_2  = 0x13,
        Channel3_TIM16_UP_2   = 0x13,
        
        Channel5_SPI2_TX      = 0x14,
        Channel5_USART1_RX_2  = 0x14,
        Channel5_USART2_RX    = 0x14,
        Channel5_I2C2_RX      = 0x14,
        Channel5_TIM1_CH3     = 0x14,
