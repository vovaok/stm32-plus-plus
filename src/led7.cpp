...
const uint8_t Led7::font[256] =
{
    ...
    (uint8_t)~0x77, (uint8_t)~0x7d, (uint8_t)~0x7F, (uint8_t)~0x31, (uint8_t)~0x00, (uint8_t)~0x79, (uint8_t)~0x00, (uint8_t)~0x4F,
    (uint8_t)~0x3e, (uint8_t)~0x3e, (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x76, (uint8_t)~0x3F, (uint8_t)~0x37,
    (uint8_t)~0x73, (uint8_t)~0x39, (uint8_t)~0x00, (uint8_t)~0x6e, (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0xbe, (uint8_t)~0x66,
    (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x7c, (uint8_t)~0x7e, (uint8_t)~0x7c, (uint8_t)~0x4f, (uint8_t)~0x00, (uint8_t)~0x67,
    (uint8_t)~0x77, (uint8_t)~0x7d, (uint8_t)~0x7F, (uint8_t)~0x50, (uint8_t)~0x5f, (uint8_t)~0x7b, (uint8_t)~0x00, (uint8_t)~0x4f,
    (uint8_t)~0x1c, (uint8_t)~0x1c, (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x76, (uint8_t)~0x5c, (uint8_t)~0x54,
    (uint8_t)~0x73, (uint8_t)~0x58, (uint8_t)~0x00, (uint8_t)~0x6e, (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x9c, (uint8_t)~0x66,
    (uint8_t)~0x00, (uint8_t)~0x00, (uint8_t)~0x7c, (uint8_t)~0x7e, (uint8_t)~0x7c, (uint8_t)~0x4f, (uint8_t)~0x00, (uint8_t)~0x67,
};
